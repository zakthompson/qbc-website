...
const Contact = () => (
  <section className={styles.wrap}>
    <div className={styles.info}>
      ...
      <em>Follow Us:</em>
      <div>
        <a className={styles.socialLink} href="https://www.facebook.com/queenswaybaptist/"><i className="fa fa-facebook" /></a>
        <a className={styles.socialLink} href="https://www.instagram.com/queenswaybaptist/"><i className="fa fa-instagram" /></a>
      </div>
    </div>
